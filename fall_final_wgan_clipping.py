# -*- coding: utf-8 -*-
"""fall final: WGAN clipping.ipynb
...
# `````
        dD_h3_real = D_W4.T @ dD_real
        dD_h3_real *= leaky_relu_deriv(D_real_h3)

        dD_h3_fake = D_W4.T @ dD_fake
        dD_h3_fake *= leaky_relu_deriv(D_fake_h3)
